...
const fileItem = tv({
  slots: {
    ...
    icon: 'borderviolet100 rounded-full border-4 bg-violet-200 p-2 text-violet-600 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-500',
    deleteButton: '',
  },
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            <span className="dark:text-error-400 text-sm font-medium text-red-700">
              Upload failed, please try again.
            </span>
            <span className="text text-error-600 dark:text-error-500 text-sm">
              {name}
            </span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          ...
          <div className="flex w-full items-center gap-3">
            <div className="h-2 flex-1 rounded-full bg-zinc-100 dark:bg-zinc-600">
              <div
                className="h-2 flex-1 rounded-full bg-violet-600 dark:bg-violet-400"
